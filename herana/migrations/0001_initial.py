...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(max_length=512, verbose_name='Please enter the name of the engagement project for which you wish to capture the details.')),
                ...
                ('adv_group_rep', models.ManyToManyField(to='herana.AdvisoryGroupRep', verbose_name='If yes, are any of the following members of the advisory group?', blank=True)),
