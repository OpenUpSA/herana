...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('project_status', models.CharField(max_length=1, null=True, verbose_name='Project statutus', choices=[(1, 'Complete'), (2, 'Ongoing')])),
                ...
                ('authors', models.PositiveIntegerField(null=True, verbose_name='How many authors were involved in the writing of the project proposal/plan?', choices=[(1, 'One author'), (1, 'More than one author')])),
                ...
                ('collaboration_detail', models.ManyToManyField(to='herana.Collaborators', verbose_name='If yes, please describe')),
                ('course_req_detail', models.ManyToManyField(to='herana.CourseReqDetail', verbose_name='If yes, please describe')),
        ...
        migrations.AddField(
            ...
            name='funding',
            field=models.ManyToManyField(to='herana.ProjectFunding', verbose_name='Please list sources of project funding, the number of years for which funding has been secured, and the amount of funding (in US$)'),
        ),
        migrations.AddField(
            model_name='projectdetail',
            name='header',
            field=models.ForeignKey(related_name='project_detail', verbose_name='Please select the engagement project for which you wish to capture the details.', to='herana.ProjectHeader'),
        ),
        migrations.AddField(
            model_name='projectdetail',
            name='new_course_detail',
            field=models.ManyToManyField(to='herana.NewCourseDetail', verbose_name='If yes, please describe'),
        ),
        migrations.AddField(
            model_name='projectdetail',
            name='outputs',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='herana.PHDStudent', verbose_name='If yes, please provide their names'),
        ),
        migrations.AddField(
            model_name='projectdetail',
