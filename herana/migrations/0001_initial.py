    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curriculum_changes', models.CharField(max_length=1, null=True, verbose_name='9.1: Has the project led to any contributions or changes to the curriculum?', choices=[(b'Y', 'Yes'), (b'N', 'No')])),
